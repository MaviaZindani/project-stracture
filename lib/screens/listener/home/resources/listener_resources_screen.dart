...
class ListenerResourcesScreen extends StatelessWidget {
  const ListenerResourcesScreen({super.key});
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                      image: DecorationImage(
                          image: AssetImage(AppImages.listenerresourcesCover),
                          fit: BoxFit.cover)),
                ),
                Container(
                  height: height * 0.5,
                        ...
                        children: [
                            ...
                            child: GestureDetector(
                              onTap: () {
                                AppNavigation.navigateTo(
                                    AppRoutesNames.listenerGovermentSourcesMainScreen);
                              },
                              child: Container(
                                height: height * 0.17,
                                decoration: BoxDecoration(
                          ...
                          Expanded(
                            child: GestureDetector(
                              onTap: () {
                                AppNavigation.navigateTo(
                                    AppRoutesNames.listenerJobMainScreen);
                              },
                              child: Container(
                                height: height * 0.17,
                                decoration: BoxDecoration(
