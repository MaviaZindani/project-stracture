...
class ListenerJobMainScreen extends StatelessWidget {
  const ListenerJobMainScreen({super.key});
            ...
            ScreenPadding(
              child: Column(
                children: [
                  ...
                  const AddHeight(0.02),
                  GestureDetector(
                    onTap: ()=>AppNavigation.navigateTo(AppRoutesNames.listenerJobDetailScreen),
                    child: Container(
                      // height: 111,
                      width: double.maxFinite,
                      padding: const EdgeInsets.symmetric(
