...
import '../broadcast/widgets/broadcast_user_tile.dart';

class ListenerConnectUserScreen extends StatelessWidget {
  const ListenerConnectUserScreen({super.key});
              ...
              child: Column(
                ...
                children: [
                  Hero(
                    ...
                    child: Text("Search and Connect Receiver",
                  ...
                  Container(
                    ...
                    child: const Column(
                      ...
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        ListenerBroadCastUserTile(isPrimary: true),
                        Divider(
                          height: 1,
                          color: DesignConstants.kButtonBg2,
                        ),
