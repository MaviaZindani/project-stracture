...
class ListenerProfileDataSettingsScreen extends StatelessWidget {
  const ListenerProfileDataSettingsScreen({super.key});
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                      image: DecorationImage(
                          image: AssetImage(AppImages.listenerCreateDataCover),
                          fit: BoxFit.cover)),
                ),
                Container(
                  height: height * 0.5,
                        ...
                        children: [
                          Expanded(
                            child: GestureDetector(
                              onTap: () {
                                AppNavigation.navigateTo(AppRoutesNames
                                    .listenerViewProfileDataScreen);
                              },
                              child: Container(
                                height: height * 0.19,
                                decoration: BoxDecoration(
                          ...
                          Expanded(
                            child: GestureDetector(
                              onTap: () => AppNavigation.navigateTo(
                                  AppRoutesNames.setCommunicationScreen),
                              child: Container(
                                height: height * 0.19,
                                decoration: BoxDecoration(
                                    borderRadius: BorderRadius.circular(14.0),
