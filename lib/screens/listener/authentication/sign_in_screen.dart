...
class ListenerSignInScreen extends StatelessWidget {
  const ListenerSignInScreen({super.key});
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              GestureDetector(
                onTap: () {
                  AppNavigation.navigateTo(AppRoutesNames.listenerForgotPasswordScreen);
                },
                child: Text(
                  "Forget Password?",
                  style: GoogleFonts.nunito(
              ...
              Hero(
                ...
                child: GestureDetector(
                  onTap: () {
                    AppNavigation.navigateTo(AppRoutesNames.listenerHomeScreen);
                  },
                  child: Container(
                    height: 60,
                  ...
                  TextSpan(
                    recognizer: TapGestureRecognizer()
                      ..onTap = () {
                        ...
                        AppNavigation.navigateTo(AppRoutesNames.listenerSignUpScreen);
                      },
                    text: 'Sign Up',
                    style: GoogleFonts.nunito(
                      fontWeight: FontWeight.w400,
