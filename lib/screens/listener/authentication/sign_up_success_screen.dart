...
class ListenerSignUpSuccessScreen extends StatelessWidget {
  const ListenerSignUpSuccessScreen({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Column(
        ...
        children: [
          DeafAssetImage(imagePath: AppImages.signupSuccessTopCircleListener),
          const AddHeight(0.1),
          DeafAssetImage(imagePath: AppImages.thumbsUpListenerSuccess),
