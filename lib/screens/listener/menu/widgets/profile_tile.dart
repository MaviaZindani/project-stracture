...
class ListenerProfileTile extends StatelessWidget {
  final String title;
  final String iconPath;
  final VoidCallback onTap;
  const ListenerProfileTile({
    required this.title,
          ...
          Row(
            ...
            children: [
              SizedBox(
                height: 21,
                width: 19,
                child: DeafAssetImage(imagePath: iconPath, color: DesignConstants.kPrimaryColor2,),
              ),
              const AddWidth(0.04),
              Text(
                title,
