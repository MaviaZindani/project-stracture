...
class EmergencyMainScreen extends StatelessWidget {
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                      image: DecorationImage(
                          image: AssetImage(AppImages.emergencyCover),
                          fit: BoxFit.cover)),
                ),
                Container(
                  // height: height * 0.5,
                      ...
                      children: [
                        Container(
                          ...
                          child: ListTile(
                            ...
                            leading: DeafAssetImage(
                                imagePath: AppImages.emergencyIcon1),
                            title: Text(
                              "Emergency 1",
                              style: GoogleFonts.nunito(
                                  fontWeight: FontWeight.w600, fontSize: 16),
                            ...
                            subtitle: Text(
                              "Call 911 and Family Record audio video",
                              style: GoogleFonts.nunito(
                                  fontWeight: FontWeight.w600, fontSize: 16),
                            ),
                            trailing: Icon(
                        ...
                        Container(
                          ...
                          child: ListTile(
                            onTap: () {},
                            leading: DeafAssetImage(
                                imagePath: AppImages.emergencyIcon2),
                            title: Text(
                              "Emergency 2",
                              style: GoogleFonts.nunito(
                                  fontWeight: FontWeight.w600, fontSize: 16),
                        ...
                        Container(
                          ...
                          child: ListTile(
                            onTap: () {},
                            leading: DeafAssetImage(
                                imagePath: AppImages.emergencyIcon3),
                            title: Text(
                              "Emergency 3",
                              style: GoogleFonts.nunito(
                                  fontWeight: FontWeight.w600, fontSize: 16),
                            ...
                            subtitle: Text(
                              "Record audio video and save it.",
                              style: GoogleFonts.nunito(
                                  fontWeight: FontWeight.w600, fontSize: 16),
                            ),
                            trailing: Icon(
                        ...
                        Container(
                          ...
                          child: ListTile(
                            ...
                            leading: DeafAssetImage(
                                imagePath: AppImages.emergencyIcon4),
                            title: Text(
                              "Non Emergency 4",
                              style: GoogleFonts.nunito(
                                  fontWeight: FontWeight.w600, fontSize: 16),
