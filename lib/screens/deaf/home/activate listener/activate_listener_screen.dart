...
class ActivateListenerMainScreen extends StatelessWidget {
  const ActivateListenerMainScreen({super.key});
                        ...
                        children: [
                            ...
                            child: GestureDetector(
                              onTap: () {
                                AppNavigation.navigateTo(
                                    AppRoutesNames.activateListenerScreen);
                              },
                              child: Container(
                                height: height * 0.17,
                                decoration: BoxDecoration(
                          ...
                          Expanded(
                            child: GestureDetector(
                              onTap: () {
                                AppNavigation.navigateTo(
                                    AppRoutesNames.showUsersScreen);
                              },
                              child: Container(
                                height: height * 0.17,
                                decoration: BoxDecoration(
                          ...
                          Expanded(
                            child: GestureDetector(
                              onTap: () => AppNavigation.navigateTo(
                                  AppRoutesNames.showPairsScreen),
                              child: Container(
                                height: height * 0.17,
                                decoration: BoxDecoration(
                                    borderRadius: BorderRadius.circular(14.0),
