...
class BroadCastUserTile extends StatelessWidget {
  const BroadCastUserTile({super.key});
        ...
        children: [
          Container(
              ...
              decoration: const BoxDecoration(
                  ...
                  color: DesignConstants.kLightRedColor),
              child: DeafAssetImage(imagePath: AppImages.deafIcon)),
          const SizedBox(
            width: 8.0,
          ),
          Container(
            ...
            decoration: BoxDecoration(
                color: DesignConstants.kDarkGreyColor,
